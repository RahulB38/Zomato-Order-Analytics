...
Sheet	Purpose
Dashboard	The visual front-end — filters, KPI cards, all 8 charts
Calc_Engine	Hidden formula layer — every SUMIFS/COUNTIFS breakdown table that feeds the charts and KPIs
